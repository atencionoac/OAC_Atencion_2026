...
if not df_completo.empty:
    ...
    with col_contenido_der:
        st.title("📊 Cuadro de Mando de Proyectos OAC")
                ...
                if not resultado_especifico.empty:
                    ...
                    with st.container(border=True):
                        ...
                        with subtab_proyecto:
                            ...
                            with c2:
                                st.metric(label="Monto Asignado", value=f"${proyecto['Monto del proyecto']:,.2f}")
        ...
        with tab_estadisticas:
            ...
            if evento_sel == "Todos":
                ...
                with col_g4:
                    st.markdown(f"#### ⚠️ Distribución por Plan de Financiamiento")
                    if total_r > 0:
